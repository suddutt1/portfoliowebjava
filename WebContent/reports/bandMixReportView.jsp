...
<body>
<div id="appToolBar" >
<span style="font-weight: bold;font-size: 2em;" >Band Mix report</span>
...
<div id="dataDisplay">
<p><br/></p>
<table id="reportDataTbl" class="display dt-center" cellspacing="0" width="100%">
    <thead>
        <tr>
			<th>Band</th>
			<th>Weightage</th>
...
$(document).ready(function(){
	...
	dataTable = $('#reportDataTbl').DataTable( {
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                d.reportType = "BANDMIX_REPORT";
            }
		}
		,
		"columns": [
			{ "data" : "rowLine.subBand"  },
			{ "data" : "rowLine.weightage" },
			{ "data" : "rowLine.fte" },
			{ "data" : "rowLine.fteRatio" },
			{ "data" : "rowLine.bandMix" },
        ]
        });
