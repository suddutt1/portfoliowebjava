...
<body>
<div id="appToolBar" >
<span style="font-weight: bold;font-size: 2em;" >Location report</span>
...
$(document).ready(function(){
	...
	dataTable = $('#reportDataTbl').DataTable( {
		...
		"columns": [
			{ "data" : "uomName" },
			{ "data" : "rowLine.KOLKATA" },
			{ "data" : "rowLine.CHENNAI" },
			{ "data" : "rowLine.BANGALORE" },
			{ "data" : "rowLine.GURGAON" },
			{ "data" : "rowLine.HYDERABAD" },
			{ "data" : "rowLine.NCR" },
			{ "data" : "rowLine.NOIDA" },
			{ "data" : "rowLine.PUNE" },
